...
#    dxglist[[length(dxglist)+1]]=mygg 
    print( interactions::probe_interaction(mdl, pred = 'yearsbl', modx = 'TDX',confint=F, facet.modx=F, interval=T, main.title=ttl, y.label=shorten_pymm_names(voi), data=temp2 )$interactplot   )
#    print( dxglist[[length(dxglist)]] )
#    print( mygg )
#    visreg::visreg(mdl,'yearsbl',by='TDX')
    Sys.sleep(1)
    temp2L$yearsblr=round(temp2L$yearsbl)
    print( plotSubtypeChange(temp2L,'commonID',vois[2],'TDX','yearsblr',whiskervar='se') )
...
# dxdfT1sel$minpSS = insight::format_p(  dxdfT1sel$minpSS, digits=4  )
# dxdfT1sel$minpMX = insight::format_p(  dxdfT1sel$minpMX, digits=4  )
