...
#    othdxform=gsub("studyName","1",dxform)
  ...
  bform = paste( voi, " ~ brainVolume_BL+commonEdu+duration_yrs+", othdxform )
...
#  if ( any(  mycoffs[ multigrep( c("PD","MCI"),rownames(mycoffs)), 5 ] < 1e-3 ) ) {
  ...
  if ( (anvp < 0.01/length(nmstotest2) | sample(1:200,1)==5) ) {
...
#    Sys.sleep(1)
    ...
    print(paste(shorten_pymm_names(voi),anvp))
