...
```{r neuromelanin,echo=FALSE,eval=TRUE,fig.width=6,fig.height=6,warning=FALSE,message=FALSE,fig.cap='Partial regression plots for example regions that show omnibus level fwe significant differences from controls.'}
######
dxglist=list()
dxdfNM=data.frame()
...
```{r neuromelanin2h,echo=FALSE,eval=TRUE,fig.width=6,fig.height=4.5,warning=FALSE,message=FALSE,fig.cap='Partial regression plots for example regions that show omnibus level fwe significant differences from controls.'}
#############################################
th=0.5
...
```{r neuromelaninQC,echo=FALSE,eval=TRUE,fig.width=6,fig.height=6,warning=FALSE,message=FALSE,fig.cap='Partial regression plots for example regions that show omnibus level fwe significant differences from controls.'}
library( fpc )
...
```{r neuromelanin3,echo=FALSE,eval=TRUE,fig.width=8,fig.height=12,warning=FALSE,message=FALSE,fig.cap='Partial regression plots for example regions that show omnibus level fwe significant differences from controls.'}
###################
###################
