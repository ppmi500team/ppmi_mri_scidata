...
```{r quicklmdx,echo=FALSE,eval=buildsci,fig.width=9,fig.height=12,warning=FALSE,message=FALSE,results='asis'}
###################
dxglist=list()
dxdfT1=data.frame()
...
mycap='Time independent group effects in PPMI PD.'
...
mycap='Longitudinal group effects in PPMI PD.'
print(dxdfT1selz, type = "latex",size=2,caption=mycap,sidewaystable=TRUE)
```

```{r quicklmcog,echo=FALSE,eval=buildsci2,fig.width=10,fig.height=6,warning=FALSE,message=FALSE}
#########################################################
...
\end{split}
$$
Paired comparison of the correlation between real and predicted UPDRS1 change scores determines that the 3 IDP model improves the data fit significantly over both the baseline (`r insight::format_p(mvanvp3,digits=4)`) and 1 IDP model (`r insight::format_p(mvanvpu,digits=4)`). Figure FIXME demonstrates the distribution of performance between the clinical and 3 IDP models over all of the simulations.  This example demonstrates the potential of multimodal neuroimaging and integrative statistical approaches in PD and neurodegenerative disease research more generally.
