...
mydogU <- dplyr::distinct( subset_and_combine_studies(
  df = mydog, 
...
mydogp = apply_simlr_matrices(  ppmitrim, presim, robust=FALSE, 
  ...
  absolute_value=rep(TRUE,length(presim)) )[[1]]  %>% distinct()
