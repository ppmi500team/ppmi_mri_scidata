...
ppmitrim = ppmi[ ppmi$studyName == 'PPMI' & !(ppmi$subjectID == "101021" ),]
  ...
  for ( voi in nmstotest ) {
    ...
    if ( antspymm_vartype( voi ) == "rsfMRI" )  {
      motname = paste( paste0( "rsfMRI_fcnxpro",num,"_n_outliers_BL"), " + ",
        paste0( "rsfMRI_fcnxpro",num,"_FD_max_BL"))
      motname = paste0( "rsfMRI_fcnxpro",num,"_FD_max_BL")
      maxy=2.5
      }
    if ( antspymm_vartype( voi ) == "DTI" )  {
      motname = "DTI_dti_FD_max_BL"
      maxy=3.0
    }
