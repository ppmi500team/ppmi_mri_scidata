...
Until very recently, the presence of alpha synuclein pathology in the brain could only be confirmed post-mortem.  However, the synuclein amplification assay (SAA) has revolutionized PD research by providing the first indirect measure of the disease's pathology during life.  Furthermore, the Parkinson's Progression Markers Initiative (PPMI) study has released a large cohort of subjects with both SAA status and multiple modality MRI.  These data provide -- for the first time -- an opportunity to track progressive changes in brain structure and function linked to biomarker-confirmed synucleinopathy in PD and related disorders.

Despite this opportunity, the PD research community faces the significant hurdle of deciphering complex multi-modality MRI data. Each MRI modality offers unique insights into PD's multifaceted nature but collectively, they present a formidable challenge for data analysis due to the high-dimensional nature and large computational burden of processing volumetric and time-series MRI. Thus, consistent, accessible and concise representations of these data will fill a pressing need for researchers.

This study leverages the rich MRI data from PPMI, encompassing various modalities that capture different dimensions of PD. The core innovation lies in transforming M3RI into an organized, tabular format. This conversion aims to make the data more accessible and interpretable for advanced statistical analyses and ML applications.  PPMI M3RI data is transformed into a structured format using ANTsX, improving accessibility and analysis for PD research.
...
This transparent, open-source tabular conversion streamlines the PPMI M3RI data and enhances its accessibility and interpretability for both clinical and technical researchers.
