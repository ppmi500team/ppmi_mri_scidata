...
glossary_add(
  term = "asyn SAA",
  def = "Synuclein Amplification Assay, a test used to stratify participants as either alpha-synuclein positive or negative.", replace = TRUE)
