...
rsfnamescnx = c( 
  getNamesFromDataframe( c("rsfMRI_fcnxpro122","_2_","Vis","efaul"),  ppmi, exclusions=xcl ) )
...
# Print the ztable object, ensuring it's treated as LaTeX code
dxdfT1selz=ztable(dxdfT1sel[, dxdfT1selcols])
mycap='Significant (fwe) longitudinal diagnostic group effects: T1w, DTI and rsfMRI (n.s.)'
print(dxdfT1selz, type = "latex",size=4,caption=mycap,sidewaystable=TRUE)
...
```{r quicklmcog,echo=FALSE,eval=buildsci,fig.width=13.5,fig.height=12,warning=FALSE,message=FALSE}
#########################################################
...
#      print( mycoffs[ , -c(1:3)] )
  #    print( voi )
      ...
      print( interactions::interact_plot( mdl, 
        'yearsbl', mod2='TDX',  
        main.title=ttl, interval=TRUE, 
...
mycap='Significant (fwe) IDP-UPDRS longitudinal  effects: T1w, DTI and rsfMRI'
print(qdfsigz, type = "latex",size=4,caption=mycap,sidewaystable=TRUE)
