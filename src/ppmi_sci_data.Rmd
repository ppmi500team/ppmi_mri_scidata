...
mycap="Table 2. Baseline PPMI and ADNI IDP cohort from which technical validation reporting is derived. These sample sizes are based on raw data i.e. not filtered for image quality. MSA = multi-system atrophy; RBD = REM Sleep Behavior Disorder; SMC = subjective memory complaint."
####
```
...
mydogU[ na2f( mydogU$joinedDX == 'SMC' & mydogU$AsynStatus == 'Negative'), 'TDX']='CN'
...
## IDP differences in asyn SAA+ and asyn SAA- sporadic PD versus controls
