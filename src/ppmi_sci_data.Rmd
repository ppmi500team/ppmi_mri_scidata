...
normalizersfmri = function( dd, applyit='meansd' ) {
  nums=c(122,129,134)
...
temp = normalizersfmri( temp, 'none')
...
#    print( mycoffs )
#    print( dxdf[n,] )
    print(prplot( mdl, 'yearsbl', dxvar, paste(voi,anvp), colorvar='commonSex', addpoints=1))
  }
}
