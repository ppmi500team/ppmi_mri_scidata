...
We classify PD and control cases based on the available data.

```{r classified,echo=FALSE}
...
print( mycvagg )
#########################
g1=( ggstatsplot::ggbetweenstats( mycv, mdl, bacc, p.adjust.method = 'holm', pairwise.comparisons = F ) + ggtitle(paste("Bal. Acc. T1 @")))
g2=( ggstatsplot::ggbetweenstats( mycv, mdl, acc, p.adjust.method = 'holm', pairwise.comparisons = F ) + ggtitle(paste("Raw Acc. T1 @")))
