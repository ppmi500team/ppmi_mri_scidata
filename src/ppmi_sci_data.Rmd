...
Parkinson's Disease (PD) represents a progressive neurodegenerative disorder characterized by a long pre-symptomatic phase followed by an array of motor and non-motor symptoms. The pathological hallmark of PD is the accumulation of Lewy Bodies in specific brain regions such as the substantia nigra. These pathological inclusions are composed of misfolded alpha-synuclein, a protein predominantly located in the presynaptic terminals of neurons. Importantly, the topographical distribution and quantitative density of Lewy Bodies correlates with the clinical manifestations and temporal progression of PD.

Until very recently, the presence of alpha synuclein pathology in the brain could only be confirmed post-mortem.  However, the synuclein amplification assay (SAA) has revolutionized PD research by providing the first measure of the disease's pathology during life.  Furthermore, the Parkinson's Progression Markers Initiative (PPMI) study has released a large cohort of subjects with both SAA status and multiple modality MRI.  These data provide an opportunity to track progressive changes in brain structure and function linked to biomarker-confirmed synucleinopathy in PD and related disorders.

Deciphering the relationship between SAA status and longitudinal multi-modality MRI in PPMI requires a representation of these data that is accessible to the broader PD research community. Each MRI modality offers unique insights into PD's multifaceted nature but collectively, they present a formidable challenge for data analysis due to the high-dimensional nature and large computational burden of processing volumetric and time-series MRI. Thus, consistent, accessible and concise representations of these data will fill a pressing need for researchers and lead to new insights into PD.


The study utilizes the Advanced Normalization Tools X (ANTsX) ecosystem to process PPMI MRI datasets from 2010 to 2023, focusing on T1-weighted, diffusion-weighted, and resting-state MRI for analyzing neurodegenerative diseases. This long-term data collection highlights the need for robust processing methods due to image quality heterogeneity. ANTsX, leveraging decades of MRI analysis expertise, employs advanced techniques and integrates open science, deep learning, and machine learning for efficient data processing. This approach is validated by Tustison et al. (2021) who detailed ANTsX's capabilities in quantitative imaging analysis, demonstrating its utility in medical image analysis through enhancements in statistical, visualization, and deep learning functionalities [(Tustison et al., 2021)](https://www.nature.com/articles/s41598-021-87564-6).

Technical validity for these methods is established in part by prior efforts including but not limited to several open quantitative MRI analysis challenges.  We add to this foundation by establishing ANTsX reproducibility/reliability in three traveling subject cohorts and an additional young control cohort.  The traveling subject cohorts are combined to provide specific and reproducible estimates of reliability (via intra-class correlation) across a variety of scanner manufacturers and models and imaging modalities.  The young control cohort -- the pediatric template of brain perfusion (PTBP) data -- provides face validity that multiple modality tabular data (as processed by ANTsX) may be combined to improve prediction of population characteristics.  In summary, these supplemental analyses provide numerical reference for reliability and predictive power that may be used to inform power analyses in other contexts.

To establish face validity for Parkinson's Disease (PD), this study leverages data to reproduce models identified in prior studies of Magnetic Resonance Imaging (MRI) within the Parkinson's Progression Markers Initiative (PPMI). Historically, research on PD has primarily utilized T1-weighted (T1w) structural imaging to investigate the neuroanatomical changes associated with the disease. A consistent finding across these studies has been the identification of early neurodegeneration in mid-brain regions, particularly the substantia nigra. This neurodegeneration has been corroborated by post-mortem analyses, which indicate that the clinical onset of PD symptoms is associated with the loss of dopaminergic neurons in the substantia nigra [(Kordower et al., 2013)](https://doi.org/10.1002/mds.25687). 

Diffusion MRI (dMRI) has further enhanced our understanding by allowing for the investigation of white matter microstructural integrity. Through metrics such as Fractional Anisotropy (FA) and Mean Diffusivity (MD), dMRI has provided evidence of altered white matter connectivity in PD, supporting the hypothesis of widespread neurodegenerative processes beyond the substantia nigra [(Planetta et al., 2016)](https://doi.org/10.1016/j.neuroimage.2015.09.062). 

Similarly, Resting-State Functional MRI (rs-fMRI) has unveiled alterations in network connectivity in PD patients, highlighting changes in the functional integration and segregation of brain networks involved in motor and cognitive functions. These findings suggest that PD impacts both the structural and functional aspects of brain connectivity, pointing towards a more integrative approach to understanding the disease's pathology [(Tessitore et al., 2012)](https://doi.org/10.1002/hbm.21224). 

The current contribution builds upon these foundational analyses by demonstrating how both structural and functional MRI data can be integrated to provide a more comprehensive understanding of PD pathology. This approach not only supports the findings from T1w structural imaging, dMRI, and rs-fMRI analyses but also extends them by offering new insights into the complex interplay between structural and functional brain alterations in PD. Through this integrative methodology, we aim to contribute to a deeper understanding of PD, facilitating the development of more effective diagnostic and therapeutic strategies.
