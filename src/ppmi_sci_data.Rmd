...
qdfsignnh = qdfsignnh[,c(qdfcols,"SiMLR1","SiMLR2")]
...
qdfsigzNNH=ztable(toviz,zebra=2,tabular=F)
...
As in the prior section, we employ LMMs to measure the relationship of baseline IDP values to clinical decline as evaluated by MDS-UPDRS 1, 2 and 3 (off) scores.  While these clinical measurements have well-documented limitations in terms of reliability and interpretability [@on_behalf_of_the_parkinsons_progression_markers_initiative_parkinsons_2023], they are consistently available in PPMI.  These exemplar assessments differ from the prior section in that they focus only on SAA$+$ sporadic PD subjects.  These models are of the form:
