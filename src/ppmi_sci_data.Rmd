...
mytbl$duration.yrs[ mytbl$joinedDX %in%  c( "CN", "Sporadic.Prodromal") ]=0
...
mycap="Table 2. Baseline PPMI and ADNI IDP cohort from which technical validation reporting is derived. These sample sizes are based on raw data i.e. not filtered for image quality. MSA = multi-system atrophy; RBD = REM Sleep Behavior Disorder."
####
```
...
print(sttblPD, type = "latex",size=4,caption=mycap,sidewaystable=FALSE)
