...
mycap='Significant (fwe based on omnibus model p-value) diagnostic group i.e. time independent effects in PPMI PD groups.  Empty cells represent very small effects.'
...
mycap='Significant (fwe based on omnibus model p-value) longitudinal diagnostic group effects in PPMI PD groups. Empty cells represent very small effects.'
print(dxdfT1selz, type = "latex",size=2,caption=mycap,sidewaystable=TRUE)
```
...
print( gghistogram(cvdf[cvdf$model %in% c("clin","idp3"),], 
  ...
  color = "model", fill = "model", palette='jco', title=ttl ) )
####################################################
####################################################
if ( FALSE ) {
  m='err'
  ...
  print( gghistogram(cvdf[cvdf$model %in% c("clin","idp3"),], 
    x = m, add = "mean", rug = TRUE,
    color = "model", fill = "model", palette='jco', xlab='correlation of real to predicted change' ) )
}
####################################################
