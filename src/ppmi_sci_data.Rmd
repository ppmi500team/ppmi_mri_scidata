...
# derka
myregions = data.frame( IDP=nmstotest, IDPcln=shorten_pymm_names(nmstotest))
myregions = data.frame( IDP=shorten_pymm_names(nmstotest))
...
#myregionsz=ztable(myregions)
mycap='Pre-defined PD regions in ANTsPyMM.'
# print(myregionsz, type = "latex",size=3,caption=mycap,sidewaystable=FALSE)
myregions %>%
