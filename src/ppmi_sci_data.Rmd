...
```{r maketrim,echo=FALSE,eval=TRUE}
ntokeep = 2950
...
t1vars = c(t1namesctx,t1namescit,t1namesctxa,t1namescita)
ppmitrim0 = ppmitrim[ , c("subjectID","age_BL",'commonSex', "hy_BL", "duration_yrs","LEDD","moca",updnames, msnames, 'joinedDX','AsynStatus',"educ","race",'tau','ptau','abeta', 'yearsbl', 'EVENT_ID', 'date', 'filename', 'brainVolume', t1vars, 'imaging_protocol', 'T1Hier_resnetGrade' ) ]
# write.csv( ppmitrim0, '~/Downloads/ppmitrim0_SR_first.csv',row.names=FALSE)
# head( ppmitrim0, 2 )
