...
if ( ! exists("clin2b") ) {
  ...
  # add tracker
  tracker = read.csv("/Users/stnava/code/multidisorder/data/ppmi_2_0_internal_scan_tracking_report_v12-2024-02-08.csv")
...
for ( voi in nmstotest ) {
  ...
  temp2 = mydog[ !is.na( mydog[,voi]) & 
    ...
    subtyper::fs(mydog$DTI_mean_fa.splenium_of_corpus_callosum.jhu_icbm_labels_1mm > 0.43)&
    subtyper::fs(mydog$DTI_mean_fa.superior_corona_radiata.LRAVG.jhu_icbm_labels_1mm > 0.25)&
    subtyper::fs(mydog$DTI_mean_fa.splenium_of_corpus_callosum.jhu_icbm_labels_1mm < 0.475), ]
  mdl=lmer( newform, data=temp2 )
  temp3 = temp2[ names(predict(mdl)),]
  temp3 = scaleqvars( temp3, newform )
  mdl=lmer( newform, data=temp3 )
...
dxdfDTI[ multigrep(c('mean_fa',"fornix"),dxdfDTI$voi,intersect=TRUE),'voi']='DTI_mean_fa_fornix'
dxdfDTI[ multigrep(c('mean_md',"fornix"),dxdfDTI$voi,intersect=TRUE),'voi']='DTI_mean_md_fornix'
dxdfDTI[ multigrep(c('mean_md',"anterior_limb_of_internal_capsule"),dxdfDTI$voi,intersect=TRUE),'voi']='DTI_mean_md_al_int_cap'
dxdfDTI[ multigrep(c('mean_fa',"posterior_thalamic_radiation_"),dxdfDTI$voi,intersect=TRUE),'voi']='DTI_mean_fa_post_thal_rad'
dxdfDTI[  multigrep(c('mean_md',"posterior_thalamic_radiation_"),dxdfDTI$voi,intersect=TRUE),'voi']='DTI_mean_md_post_thal_rad'
