...
\end{split}
$$
Paired $t$-test show the 3 IDP model improves correlation between real and predicted UPDRS1 change scores versus both the baseline (`r insight::format_p(mvanvp3,digits=4)`) and 1 IDP model (`r insight::format_p(mvanvpu,digits=4)`). Figure FIXME demonstrates the distribution of performance between the clinical and 3 IDP models over all of the simulations.  This example demonstrates the potential of multimodal neuroimaging and integrative statistical approaches in PD and neurodegenerative disease research more generally.
