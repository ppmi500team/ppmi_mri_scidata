...
interactions::sim_slopes(mdl, pred = 'yearsbl', modx = !!sym(voisx[1]), jnplot = TRUE,confint=T)
interactions::sim_slopes(mdl, pred = 'yearsbl', modx = !!sym(voisx[2]), jnplot = TRUE,confint=T)
interactions::sim_slopes(mdl, pred = 'yearsbl', modx = !!sym(voisx[3]), jnplot = TRUE,confint=T)
